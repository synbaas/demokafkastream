package com.atossyntel.demokafkastream;
...
import com.atossyntel.controllers.KafkaStreamsConfiguration;
	 ...
	 public static void main(String[] args) {
		...
		/**
		  ...
		  static Properties getStreamsConfiguration(final String bootstrapServers) {
		    ...
		    streamsConfiguration.put(StreamsConfig.STATE_DIR_CONFIG, "C:\\testamit\\kafka_2.11-2.1.0\\kafka_2.11-2.1.0\\kafka-streams");
